...
### General
- [My itch.io page for any game projects](https://orange-flag.itch.io/)   
- [My Github](https://github.com/badwolf2828)     
- [My Youtube channel](https://www.youtube.com/@orangeflagstudio7841)
...
Solo project where I wrote created the logic for a 3rd person character controller and camera for a stealth game demo. The USP for the stealth game was the ability for the character to dash through walls, and also dash through enemies to kill them. The ledge climbing also implemented corner transitions and slope climbing.
